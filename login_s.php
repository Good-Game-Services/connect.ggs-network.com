                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="Login" method="POST" action="" class="form-horizontal">
								<div class="form-group"><label class="col-sm-1 control-label">Session Key</label>
									<div class="col-sm-10"><input type="text" name="session" value="<?= $session ?>" class="form-control" autocomplete="off"></div>
								</div>
								<div class="form-group">
									<div class="col-sm-4 col-sm-offset-1">
                                        ...
                                        <p>Have you a username and password? <a href="login.php">Login with username and password</a></p>
									</div>
								</div>
							</form>
                        </div>
